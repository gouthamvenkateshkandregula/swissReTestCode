...
public class ExcelHierarchyReader {

    public static List<EmployeeHierarchy> readEmployeesFromExcel(String filePath) throws IOException {
        List<EmployeeHierarchy> employees = new ArrayList<>();
        ...
        try (FileInputStream fis = new FileInputStream(filePath);
            ...
            for (int i = 1; i <= sheet.getLastRowNum(); i++) {
                ...
                try {
                    ...
                    employees.add(new EmployeeHierarchy(id, name, role, managerId));
