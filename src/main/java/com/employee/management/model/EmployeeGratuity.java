...
public class EmployeeGratuity {
    ...
    public EmployeeGratuity(int id, String name, String city, String state, String category,
    ...
    /**
     * Parse date from various formats commonly found in Excel
     */
    ...
    /**
     * Check if employee is eligible for gratuity (>60 months of service)
     */
    ...
    /**
     * Get years and months of service as formatted string
     */
